    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tagId', models.ForeignKey(related_name='tagId', blank=b'False', to='beapi.ConsumerTag')),
                ('txnId', models.ForeignKey(related_name='consumertxn_id', blank=b'False', to='beapi.ConsumerTxn')),
            ],
            options={
                'ordering': ('created',),
            },
